...
(function () {
  ...
  function monsterTierLabel(idx) { const t = MONSTER_TIERS[Math.max(0, Math.min(5, idx | 0))]; return { name: t.name, color: t.color, mul: t.mul }; }
  ...
  const MONSTERS = [
    ...
    { id: "bee", name: "野蜂", region: 0, sprite: "bee", kind: "small", tiers: { hp: 0, def: 0, atk: 2, hit: 3, dodge: 3, critDmg: 2 }, crit: 0.08, range: 1, atkInterval: 0.8, moveMul: 1.3, skills: [], special: null },
    { id: "b_slime", name: "史萊姆王", region: 0, sprite: "themedBoss:0", kind: "boss", tiers: { hp: 5, def: 2, atk: 3, hit: 2, dodge: 1, critDmg: 3 }, crit: 0.05, range: 1, atkInterval: 1.5, moveMul: 0.6, skills: ["flame"], special: "split", splitInto: "slime_small", splitCount: 3 },
    // 區1 森林
    ...
    { id: "b_spider", name: "巨蛛女王", region: 1, sprite: "themedBoss:1", kind: "boss", tiers: { hp: 5, def: 2, atk: 3, hit: 3, dodge: 2, critDmg: 2 }, crit: 0.06, range: 2, atkInterval: 1.4, moveMul: 0.8, skills: ["stunbolt", "shock"], special: "summon", summonId: "spider", summonCount: 2 },
    // 區2 沙漠
    ...
    { id: "b_scorpion", name: "蠍王", region: 2, sprite: "themedBoss:2", kind: "boss", tiers: { hp: 5, def: 4, atk: 3, hit: 2, dodge: 1, critDmg: 4 }, crit: 0.12, range: 1, atkInterval: 1.4, moveMul: 0.7, skills: ["emberbolt", "curse"], special: "enrage" },
    // 區3 雪地
    ...
    { id: "icewisp", name: "冰靈", region: 3, sprite: "icewisp", kind: "small", tiers: { hp: 0, def: 0, atk: 2, hit: 3, dodge: 4, critDmg: 2 }, crit: 0.06, range: 3, atkInterval: 1.1, moveMul: 1.0, skills: ["icebolt"], special: null },
    { id: "b_ice", name: "冰霜領主", region: 3, sprite: "themedBoss:3", kind: "boss", tiers: { hp: 5, def: 3, atk: 3, hit: 2, dodge: 1, critDmg: 3 }, crit: 0.06, range: 4, atkInterval: 1.5, moveMul: 0.7, skills: ["icebolt", "stunbolt"], special: "shield" },
    // 區4 熔岩山
    ...
    { id: "b_flame", name: "烈焰魔", region: 4, sprite: "themedBoss:4", kind: "boss", tiers: { hp: 5, def: 3, atk: 4, hit: 2, dodge: 1, critDmg: 4 }, crit: 0.08, range: 5, atkInterval: 1.5, moveMul: 0.65, skills: ["flame", "emberbolt"], special: "enrage" },
    // 區5 深海
    ...
    { id: "b_harpy", name: "鷹身女妖", region: 6, sprite: "themedBoss:6", kind: "boss", tiers: { hp: 5, def: 2, atk: 4, hit: 4, dodge: 3, critDmg: 3 }, crit: 0.1, range: 3, atkInterval: 1.3, moveMul: 0.9, skills: ["stunbolt", "bolt"], special: "enrage" },
    // 區7 遺跡
    { id: "skeleton", name: "骷髏兵", region: 7, sprite: "themedSmall:7", kind: "small", tiers: { hp: 2, def: 2, atk: 3, hit: 2, dodge: 1, critDmg: 2 }, crit: 0.06, range: 1, atkInterval: 1.0, moveMul: 1.0, skills: [], special: null },
    ...
    { id: "b_colossus", name: "遺跡巨像", region: 7, sprite: "themedBoss:7", kind: "boss", tiers: { hp: 5, def: 5, atk: 4, hit: 2, dodge: 0, critDmg: 3 }, crit: 0.05, range: 1, atkInterval: 1.6, moveMul: 0.55, skills: ["stunbolt"], special: "shield" },
    // 區8 魔王城
