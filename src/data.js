...
(function () {
  ...
  const MONSTERS = [
    ...
    { id: "icearcher", name: "霜射手", region: 3, sprite: "icearcher", kind: "small", tiers: { hp: 1, def: 1, atk: 2, hit: 3, dodge: 2, critDmg: 3 }, crit: 0.08, range: 4, atkInterval: 1.2, moveMul: 0.9, aim: "far", skills: ["icebolt"], special: null },
